...
;(function($){
    ...
    Popup.prototype.hide = function () {
        ...
        //当前节点取消激活动画状态，取消click.dismiss.popup事件
    ...
    $.fn.Popup = function (option) {
        return this.each(function () {
            ...
            var options = $.extend({}, Popup.DEFAULTS, typeof option === "object" && option);  //配置参数

            //插件的实列存放在bs.popup的html标签下
            var data = $this.data('bs.popup');     //存放插件实列
